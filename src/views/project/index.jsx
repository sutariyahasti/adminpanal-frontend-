...
// import { Button, TextField, Typography, Grid, Card, CardContent, CardMedia, Paper, Box } from '@mui/material';
...
//     try {
//       const response = await axios.post('http://localhost:7005/api/project', formData, {
//         headers: {
...
//             //   <Card sx={{ ':hover': { boxShadow: '0 2px 14px 0 rgb(32 40 45 / 8%)' }, height: '300px', overflow: 'hidden', paddingBottom: '0px' }}>
//             //     <CardMedia
//             //       component="img"
//             //       height="200"
//             //       image={`http://localhost:7005/${data.imageUrl[0]}`} // Adjust this if handling multiple images per project
//             //       alt="Project image"
//             //       sx={{
...
//       component="img"
//       height="200"
//       image={`http://localhost:7005/${data.imageUrl[0]}`}
//       alt="Project image"
//       sx={{
//         transition: 'transform 0.3s ease-in-out',
//         ':hover': {
...
//               <Card sx={{ ':hover': { boxShadow: '0 2px 14px 0 rgb(32 40 45 / 8%)' }, overflow: 'hidden', paddingBottom: '0px' }}>
//                 <div style={{ display: 'flex' }}>
//                   {data.imageUrl.map((image, imgIndex) => (
//                     <CardMedia
//                       component="img"
//                       height="200"
//                       width="auto"
//                       image={`http://localhost:7005/${image}`}
//                       alt="Project image"
//                       key={imgIndex}
//                       sx={{ padding: '10px' }}
//                     />
